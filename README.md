...
* **Controlador y Lógica de Préstamos:** Sistema que valida límites de reservas permitidos y verifica penalizaciones vigentes antes de confirmar una reserva.
* **Gestor de Perfil del Alumno:** Interfaz donde el usuario puede visualizar su historial personal, el estado de sus reservas (Pendiente, Entregado, Devuelto) y sus penalizaciones.
