...
def reportes():
    """Renderiza la vista de reportes para administradores y bibliotecarios."""
...
def normativas():
    ...
    return render_template("admin/normativas.html", normativas=normativas, normativa_editar=normativa_editar)
